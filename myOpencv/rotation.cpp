...
int main(){
    ...
    //读取图片
    srcImage = imread("/Users/zhangqr/Desktop/pics/270angle.jpg");
    ...
    //旋转矫正
    //    Mat correctImage;
    //    Point center(scrImage.cols/2,scrImage.rows/2);
    //    Mat rotMat = getRotationMatrix2D(center, -theta, 1);
    //    warpAffine(scrImage, correctImage, rotMat, Size(scrImage.size()));
